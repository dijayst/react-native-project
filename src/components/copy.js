...
export default function VideoRecordingScreen({ onNavigateToFeed }) {
     ...
     <View style={styles.container}>
      ...
      <View style={styles.controlsContainer}>
        <TouchableOpacity
          ...
          disabled={isRecording && recordTime >= RECORD_TIME_LIMIT}
        >
          <View style={[styles.recordButtonInner, isRecording && styles.recordingInner]} />
        </TouchableOpacity>
      </View>

      <TouchableOpacity style={styles.feedButton} onPress={onNavigateToFeed}>
